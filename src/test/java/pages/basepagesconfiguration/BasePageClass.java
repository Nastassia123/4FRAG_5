...
public class BasePageClass //extends DriverSingleton
 {
    ...
    private static final int WAITER_TIME_OUT = 30;
    private static final int DRIVER_WAIT_TIME = 150;
   ...
   public WebDriver initializeDriver() {
        System.setProperty("webdriver.chrome.driver", "C:\\D\\SeleniumDrivers\\DriverBinaries\\chromedriver.exe");
